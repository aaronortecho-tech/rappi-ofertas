...
- Hogar (18 de septiembre, pedido del usuario): se revisa cada 30 minutos y avisa en un resumen cada 3 horas (`hold_home` en `catalogs.py`, cola `datos.cola_hogar`). 80 % o más se envía en la misma ronda. No bajar la frecuencia de revisión para reducir avisos: el usuario pidió no perder ofertas.
