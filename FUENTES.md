...
- 19/09/2026: Sodimac Tecnología anunciaba 3.186 resultados, pero página 67 devolvía `/noResult` en `appCtx.url`. El lector reconoce únicamente ese estado explícito como vacío, reinicia la página rotativa en 2 y conserva los productos de la primera página. HTML desconocido y bloqueos siguen siendo errores. Fixture recortada sin configuración, cookies ni ubicación.
