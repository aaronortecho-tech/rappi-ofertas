...
- `state/hogar.json` guarda métricas de los últimos 28 días y el detalle de la última ronda: candidatas únicas por ronda, recortes, caducidad, confirmaciones, cambios de precio, comprobaciones fallidas, envíos y cola por categoría. Los totales diarios suman observaciones de rondas: no representan productos únicos del día. También aparecen en los registros y resumen de GitHub.
