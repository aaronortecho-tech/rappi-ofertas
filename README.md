...
- Se revisa cada 30 minutos, pero avisa en un **resumen cada 3 horas** (variable `HORAS_RESUMEN_HOGAR`). Todas las candidatas esperan en una cola guardada en la memoria, una por producto y siempre con el último precio visto. Las de 80 % o más salen en cada ronda (primero, pero ocupando como mucho 16 de los 24 cupos si hay otras pendientes); las demás, en el resumen. Si un envío falla, se reintenta en la ronda siguiente. Lo que no se vuelve a ver en 24 horas sale de la cola, y lo que lleva más de una hora esperando dice «Visto hace N h». El orden del resumen no es solo el porcentaje: pesa también el ahorro en soles (un sofá antes que un cojín) y sube lo que bajó frente al precio más bajo que el monitor había visto («📉 Precio más bajo visto en N días»). Se descartan los productos con ahorro menor a S/ 20 (variable `AHORRO_MINIMO_HOGAR`) y, cuando hay una semana de historial, los que tienen siempre el mismo precio: ese «antes» tachado es decorativo. La deduplicación entre vendedores persiste siete días: usa un SKU compartido de Falabella/Sodimac o el título completo con código de modelo alfanumérico, junto con precio, moneda, categoría y condiciones. Nombres genéricos con distintos SKU no se fusionan. Una oferta con CMR no oculta otra sin esa restricción. Esta comparación conservadora puede dejar pasar títulos diferentes del mismo producto. La cola guarda como máximo las 300 mejores no urgentes por puntaje (unas 190 caben en los resúmenes de un día); las de 80 % o más nunca se recortan. Cada envío tiene como máximo 8 mensajes de hasta 3 productos; no marca como enviadas las ofertas que quedaron fuera del límite. No repite una misma ficha/precio/condición durante 7 días. Un cambio de precio puede generar un aviso nuevo.
