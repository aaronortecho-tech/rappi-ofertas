...
- Calcula el descuento con los precios de la ficha, sin redondear hacia arriba. Incluye vendedores terceros; el vendedor se ve al abrir el enlace. Si el mínimo solo se alcanza con CMR, lo indica expresamente. Si también califica el precio web, prioriza esa opción.
- La referencia tachada del vendedor no se presenta como precio histórico. Guarda los mínimos observados durante 30 días y solo los muestra si el producto estuvo más barato («Ojo: estuvo a…»). El aviso trae solo nombre, precio, descuento, precio anterior y enlace; lo demás (vendedor, stock, envío) se revisa en la tienda. No asegura que el descuento anunciado equivalga a una rebaja frente al precio habitual.
- Se revisa cada 30 minutos y se resume cada 3 horas (`HORAS_RESUMEN_HOGAR`), hasta 8 mensajes de 3 productos. Una alerta inmediata exige descuento publicado >=80 %, precio al menos 3 % inferior al mínimo observado en tres días previos distintos (ventana de 30 días), y confirmación en el catálogo durante la ronda. El 60 % publicado sigue siendo el mínimo de entrada; la bajada histórica adicional no necesita ser 60 %.
- La selección distingue «Descuento publicado» de «Bajada respaldada». El historial propio domina la puntuación; porcentaje y ahorro anunciado aportan señales secundarias acotadas. Ahorro publicado mínimo S/20 (`AHORRO_MINIMO_HOGAR`). Un precio estable siete días pierde prioridad, pero no se afirma que el precio anterior sea ficticio ni se descarta por estabilidad solamente.
- La cola conserva las 300 mejores no urgentes alternando categorías **antes** del recorte; las urgentes respaldadas quedan fuera de ese límite. Se envían como máximo 16 urgentes si hay otras listas para el resumen. Se conserva el último precio por vendedor/condiciones y se retira lo no observado en 24 horas. No garantiza avisar de todas las ofertas.
- Antes de enviar se exige una observación de esa misma ronda. La selección avanza por la lista ordenada hasta reunir hasta 24 ofertas confirmadas: una candidata no verificable no bloquea las siguientes. Al agotar las relecturas todavía puede usar observaciones de la ronda sin consultas adicionales. Para candidatas antiguas se relee su catálogo público de origen, hasta 8 páginas y 16 solicitudes adicionales con reintentos incluidos; robots.txt y bloqueos se respetan. Una página ya leída se reutiliza. Sin confirmación no se envía ni se marca notificada. Un precio cambiado reemplaza al anterior y se evalúa en la ronda siguiente. Confirmar en el catálogo no garantiza stock, envío o precio final en tu dirección.
- Los fallos de envío conservan los pendientes y no adelantan el reloj. La deduplicación dura siete días y distingue moneda, precio, categoría y condiciones (CMR frente a precio libre). Se requiere SKU compartido o título completo con código de modelo; nombres genéricos con SKU diferentes no se fusionan.
- `state/hogar.json` guarda métricas de los últimos 28 días y el detalle de la última ronda: candidatas únicas por ronda, candidatas consideradas, confirmadas listas para enviar, recortes, caducidad, confirmaciones, cambios de precio, comprobaciones fallidas, envíos y cola por categoría. Los totales diarios suman observaciones de rondas: no representan productos únicos del día. También aparecen en los registros y resumen de GitHub.
...
Lo que sí está activo, además de Nexo, son los inmuebles adjudicados de Scotiabank: su listado trae unos 242, con distrito, área, valor y estado registral. Una vez por semana el monitor lo compara con el anterior y te avisa lo nuevo y lo que bajó 10 % o más, con partida inscrita. Incluye Lima/Callao y las provincias de Arequipa, Cusco (también escrito Cuzco), Cajamarca, Trujillo y Huaraz según las columnas del PDF; estos adjudicados pueden estar en distritos periféricos de esas provincias.

Desde el 20 de septiembre, **inmuebles también revisa Arequipa, Cusco, Cajamarca, Trujillo y Huaraz**, conservando Lima y el mismo tema de ntfy. Infocasas busca casas y departamentos en venta y alquiler publicados en los últimos 30 días; valida las coordenadas dentro de un área urbana aproximada de cada ciudad. Las comparaciones siguen limitadas a 1,5 km dentro de la misma ciudad, con ocho comparables por operación. Las alertas indican la ciudad. Una búsqueda vacía no significa ausencia de oportunidades en toda la ciudad: puede faltar oferta reciente en esa fuente.

Se mantiene el presupuesto de 60 páginas de Infocasas por ronda: 40 para Lima y cuatro para cada ciudad adicional, con cursores de página independientes. Esto alarga el recorrido de Lima respecto de las 60 páginas anteriores. Con presupuestos personalizados, cada ciudad adicional recibe `max(1, presupuesto // 15)` páginas y Lima el resto. Nexo conserva su presupuesto total y reserva hasta diez lecturas (como máximo un tercio del presupuesto) para proyectos regionales; actualmente se verificaron fichas en Arequipa y Cusco. Las otras ciudades también se aceptan cuando aparezcan proyectos en su mapa público. No se garantiza que cada fuente tenga inmuebles en las cinco ciudades. Se conserva el máximo de tres avisos por ronda y el historial existente.
